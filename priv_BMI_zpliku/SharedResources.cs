...
namespace priv_BMI_zpliku
{
    public static class SharedResources
    {
        ...
        public static string CorrectValuesInArgs = "Wpisano poprawne wartości w wierszu poleceń. Przyjęto argumenty!";

        public static string IncorrectValuesInArgs = "Brak poprawnie wpisanych wartości w wierszu poleceń";
        ...
        public static string WrongAnswerFormatThree = "Nie udało się wczytać pliku - sprawdź poprawność formatu lub uzupełnij dane!";
        ...
        public static string ExpectationOfConsoleDataSourceHeightAssignment = "Proszę podać wzrost w metrach [m] i zatwierdzić klawiszem Enter";
